...
<!-- Font Awesome -->
<link rel="stylesheet" href="<?php echo base_url('asset/asset_yellow/asset_index/fa/css/font-awesome.min.css') ?>">
<!-- Ionicons -->
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/asset_lte/plugins/jQueryUI/jquery-ui.theme.css') ?>">
